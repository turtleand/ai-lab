...
1. ¿Cuál es la diferencia entre una respuesta única de chatbot y un loop de agente?
2. ¿Por qué el agente necesita observar el resultado después de actuar?
3. ¿Dónde debería aparecer la aprobación humana dentro del loop?
4. ¿Cuál es una acción que un agente puede redactar de forma segura, y cuál no debería tomar sin aprobación?
