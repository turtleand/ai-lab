...
**Lección:** "Sin errores" no significa "funcionando correctamente." Validá el _contenido_ de los outputs, no solo si el job completó.
...
- [Documentación de Hermes Agent](https://hermes-agent.nousresearch.com/docs) — referencia de workflows y scheduling de agentes
