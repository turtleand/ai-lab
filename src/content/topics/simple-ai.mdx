...
Use Portal when you want to understand how AI Lab connects with Growth, Build, OpenClaw, Handbook, AI Atlas, and the wider public knowledge ecosystem.
...
Go to [OpenClaw](https://openclaw.turtleand.com/) when you want applied agent-system experiments and proof-of-practice notes.
...
If you can answer those, you are ready for [Module 0](/modules/module-0/).
