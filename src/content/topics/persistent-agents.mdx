...
1. Why is a persistent agent not automatically a useful agent?
2. What does Hermes add that a generic agent experiment does not?
3. Why does Turtleand treat human review as part of the system rather than a slowdown?
4. What is one workflow you would keep only if it produces more reviewable leverage than maintenance burden?
